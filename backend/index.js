...
app.get('/test-email', async (req, res) => {
  const { sendShortlistedEmail } = require('./src/services/email.service');
  try {
    await sendShortlistedEmail('dkan6406@gmail.com', 'Test User');
    res.json({ message: 'Test email sent! Check dkan6406@gmail.com' });
  } catch (error) {
